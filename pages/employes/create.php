...
<head>
    ...
    if (isset($_POST['new-object'])) {
        ...
        $object['date_naiss'] = $_POST['date_naiss'];
        $object['date_emb'] = $_POST['date_emb'];
        $object['service'] = $_POST['service'];
...
<body>
    ...
    <div class="content">
        <div class="flex justify-space-between items-center">
            <h1 class="inline-flex">Nouvel Employé</h1>
        ...
        <form class="form-container" action="" method="post" style="margin-top: 2rem;">
          ...
          <div class="fieldset flex gap-3">
            ...
            <div class="field">
              ...
              <input type="date" name="date_emb" required>
            </div>
          </div>
