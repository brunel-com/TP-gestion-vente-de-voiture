...
<body>
  ...
  <div class="content">
    ...
    <form class="form-container" action="" method="post" enctype="multipart/form-data" style="margin-top: 2rem;">
      ...
      <div class="fieldset flex">
        ...
        <div class="field">
          ...
          <input type="file" placeholder="Choisir une image pour la voiture..." name="car-img" id="car-img" required>
        </div>
      </div>
